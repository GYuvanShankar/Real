...
TEST_CASE("Irrationals") {
    ...
    SECTION("Champernowne Binary Irrational") {
        ...
        SECTION("digit check") {
            ...
            auto champernowne_itr = champernowne.get_real_itr().cend();
            std::string real_champernowne = champernowne_itr.get_interval().upper_bound.as_string();
